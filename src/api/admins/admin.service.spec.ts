...
import {AdminMockRepository} from '~/api/admins/repositories/admin.mock.repository'
...
import {AdminPasswordJournalMockRepository} from '~/api/admins/repositories/admin-password-journal.mock.repository'
