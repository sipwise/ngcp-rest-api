...
import {CustomercontactsModule} from './customercontacts.module'
...
describe('CustomercontactsService', () => {
    ...
    describe('read', () => {
        it('should return a customer contact by id', async () => {
            ...
            expect(result).toStrictEqual(await contactsMockRepo.readCustomerContactById(2, sr))
        })
    ...
    describe('readAll', () => {
        it('should return an array of customer contacts', async () => {
            ...
            expect(got).toStrictEqual(await contactsMockRepo.readAllCustomerContacts(sr))
        })
    })
    ...
    describe('create', () => {
        ...
        it('should set reseller_id to user.reseller_id if user.reseller_id_required', async () => {
            ...
            expect(result).toStrictEqual(await contactsMockRepo.readCustomerContactById(result.id, localRequest))
