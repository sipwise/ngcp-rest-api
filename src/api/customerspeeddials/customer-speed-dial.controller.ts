...
import {CustomerSpeedDialRequestDto} from '~/api/customerspeeddials/dto/customer-speed-dial-request.dto'
import {CustomerSpeedDialUpdateDto} from '~/api/customerspeeddials/dto/customer-speed-dial-update.dto'
