...
import {NCOSPatternSearchDto} from '~/api/ncos/patterns/dto/pattern-search.dto'
import {NCOSPatternRepository} from '~/api/ncos/patterns/interfaces/pattern.repository'
