...
import {HeaderManipulationRuleRequestDto} from '~/api/header-manipulations/sets/rules/dto/header-manipulation-rule-request.dto'
import {JournalService} from '~/api/journals/journal.service'
import {JournalResponseDto} from '~/api/journals/dto/journal-response.dto'
import {HeaderManipulationRuleRequestParamDto} from '~/api/header-manipulations/sets/rules/dto/header-manipulation-rule-request-param.dto'
