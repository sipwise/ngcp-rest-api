...
import {HeaderManipulationRuleConditionRequestDto} from '~/api/header-manipulations/sets/rules/conditions/dto/header-manipulation-rule-condition-request.dto'
import {JournalService} from '~/api/journals/journal.service'
import {JournalResponseDto} from '~/api/journals/dto/journal-response.dto'
import {HeaderManipulationRuleConditionRequestParamDto} from '~/api/header-manipulations/sets/rules/conditions/dto/header-manipulation-rule-condition-request-param.dto'
import {number} from 'yargs'
import {HeaderManipulationRuleConditionValueResponseDto} from '~/api/header-manipulations/sets/rules/conditions/dto/header-manipulation-rule-condition-value-response.dto'
